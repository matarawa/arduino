/*--------------------------------------------------------------
  ...
  Software:     Developed using Arduino 1.0.5 software
                ...
                Tested ok with Arduino 1.8.2
                
                Requires index.htm and page2.htm and pic.jpg to
                be on the micro SD card in the Ethernet shield
  ...
  Modified:     11 February 2020 by cheshoare
                - added else if condition to open image file
                - renamed file from eth_websrv_SD_link to
                  eth_websrv_SD_link_image
